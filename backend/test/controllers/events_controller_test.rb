...
#     expected = "[" + Attendee.find(3).to_json + "," + Attendee.find(6).to_json + "," + Attendee.find(10).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
#   test " findAttendees event 3 " do
#     get findAttendees_url(3), as: :json
#     expected = "[" + Attendee.find(2).to_json + "," + Attendee.find(4).to_json + "," + Attendee.find(7).to_json + "," + Attendee.find(11).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
#   test " findAttendees event 4 " do
#     get findAttendees_url(4), as: :json
#     expected = "[" + Attendee.find(5).to_json + "," + Attendee.find(8).to_json + "," + Attendee.find(12).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
#   test " findAttendees event 5 " do
#     get findAttendees_url(5), as: :json
#     expected = "[" + Attendee.find(9).to_json + "," + Attendee.find(13).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
#   test " findAttendees event 6 " do
#     get findAttendees_url(6), as: :json
#     expected = "[" + Attendee.find(14).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
...
#     assert_equal(Event.find(9).to_json, @response.body)
#   end
#   test "find new event" do
#     get search_path("new"), as: :json
#     expected = "[" + Event.find(9).to_json + "]"
#     assert_equal(expected,@response.body)
#   end
#   test "delete 'new' event " do
#     code = delete event_url(9), as: :json
